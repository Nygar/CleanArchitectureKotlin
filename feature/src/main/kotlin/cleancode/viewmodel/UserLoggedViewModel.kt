...
class UserLoggedViewModel @Inject constructor(
    ...
    private fun firebaseAuthWithGoogle(acct: GoogleSignInAccount, auth: FirebaseAuth, onNavigateDelegate: () -> Unit) {
    ...
    fun authWithGoogle(data: Intent, onResultLogin: () -> Unit){
